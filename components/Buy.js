...
export default function Buy({ itemID }) {
	...
	return (
		<div>
			{status === STATUS.Paid ? (
				<IPFSDownload filename="TravyPics.zip" hash="QmbcTZCqWtDijoS5YTQ7ErcdDnynNjNpWCrDDxf2jqCGsC" cta="Download Travy Pic"/>
			) : (
				<button disabled={loading} className="buy-button" onClick={processTransaction}>Buy now 🠚</button>
			)}
		</div>
	);
}